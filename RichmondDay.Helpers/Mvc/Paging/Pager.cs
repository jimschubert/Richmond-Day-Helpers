...
namespace RichmondDay.Helpers {
    public class Pager {
        ...
        public string RenderHtml() {
            ...
            sb.Append("<div class=\"Pager clearfix\">");
            // Previous
            sb.Append(currentPage > 0 ? GeneratePageLink("&lt;", currentPage) : "<span class=\"disabled\">&lt;</span>");
            ...
            // Next
            sb.Append(currentPage + 1 < pageCount ? GeneratePageLink("&gt;", (currentPage + 1 + 1)) : "<span class=\"disabled\">&gt;</span>");
            sb.Append("</div>");
            return sb.ToString();
        }
